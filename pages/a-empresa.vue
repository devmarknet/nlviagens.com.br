...
<template>
  <div>
    ...
    <main
      class="container mx-auto max-w-2xl mb-20 text-center flex flex-col items-center gap-8 text-gray"
    >
      <p>
        Somos uma empresa com mais de 25 anos no mercado de viagens e turismo,
        somos especialistas quando se trata de viagens nacionais, internacionais
        e assessoria. Temos uma equipe altamente capacitada, e consultores
        prontos para elaborar seu plano de viagem de modo que atenda suas
      ...
      <img
        :src="require('~/assets/images/sobre-nilsara.jpg')"
        alt="Avião em pleno vôo"
      />
    </main>
  </div>
</template>
